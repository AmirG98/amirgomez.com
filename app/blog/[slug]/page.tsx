        ...
        <div className="max-w-4xl mx-auto">
          ...
          <FadeInView>
            <header className="mb-12">
              ...
              {/* Featured Image */}
              {post.featuredImage && (
                <div className="relative overflow-hidden aspect-[16/9] rounded-2xl mb-8 bg-gradient-to-br from-brand-100 to-brand-200 dark:from-brand-900/30 dark:to-brand-800/30">
                  <img
